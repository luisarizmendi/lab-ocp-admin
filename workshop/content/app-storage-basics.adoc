...
### Storage Classes
An StorageClass was defined as a pre-requistite for this workshop. You can see this `StorageClass` with the following:
...
doesn't specify a `StorageClass`, the default will be used. 
